...
export class CoachController {
  ...
  @Get('coachees')
  getCoachees(@Request() req) {
    return this.service.getCoachees(req.user.userId);
  }

  @Get('coachees/:id/overview')
  getCoacheeOverview(@Param('id') coacheeId: string, @Request() req) {
  ...
  getNotes(@Param('id') coacheeId: string, @Request() req) {
